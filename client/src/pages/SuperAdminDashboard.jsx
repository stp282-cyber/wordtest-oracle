...
export default function SuperAdminDashboard() {
    ...
    const fetchBillingStats = async (user) => {
        try {
                                ...
                                {loading ? (
                                    ...
                                    <div className="divide-y divide-gray-700">
                                        {academies.map((academy) => {
                                            const stats = billingStats[academy.id] || { activeStudents: 0, suspendedStudents: 0 };
                                            return (
                                                    ...
                                                    <div className="flex items-center space-x-4">
                                                        ...
                                                        <div>
                                                            ...
                                                            <div className="mt-2 flex space-x-4 text-xs">
                                                                <span className="text-green-400">Active: {stats.activeStudents}명</span>
                                                                <span className="text-gray-500">Suspended: {stats.suspendedStudents}명</span>
                                                            </div>
                                                        </div>
                                                    </div>
